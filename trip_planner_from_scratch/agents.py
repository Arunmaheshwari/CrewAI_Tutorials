...
- Define which experts the captain need to communicate with and delegate tasks to.
...
class TravelAgents:
    def __init__(self):
        ...
        self.OpenAIGPT35 = ChatOpenAI(model_name = 'gpt-4', temperature = 0.7)
    ...
    def local_tour_guide(self):
        return Agent(
            ...
            backstory =  dedent(f"""Knowlefgeable local guide with extensive information 
